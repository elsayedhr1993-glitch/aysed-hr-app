    ...
    <div className="w-full max-w-4xl mx-auto bg-white p-8 border border-gray-200 shadow-sm print:shadow-none print:border-none print:p-0 font-sans text-slate-800" dir="rtl">
          ...
          <table className="w-full text-center text-sm border-collapse">
            <thead>
              <tr className="bg-[#71639e] text-white font-semibold">
                ...
                <th className="p-2.5 border-l border-[#5d5182]">مكتسب ٢٠٢٦</th>
      ...
      <div className="mb-8">
        <h5 className="text-base font-bold text-teal-700 border-r-4 border-teal-700 pr-2.5 mb-3">
          ٢. التسوية المالية (قاعدة ٢٦ يوم عمل)
        </h5>
            ...
            <tbody>
              <tr className="border-b border-slate-200 pb-2">
                <td className="py-2 text-slate-700">
                  إجمالي المبلغ المستحق للإجازة ({settlement.aysed_paid_days.toFixed(1)} يوم مدفوع × {settlement.aysed_daily_wage.toFixed(3)} د.ك)
                </td>
                <td className="py-2 text-left font-bold">{settlement.aysed_net_payable.toFixed(3)} د.ك</td>
              </tr>

              {settlement.aysed_unpaid_days > 0 && (
                <tr className="border-b border-slate-200 pb-2 text-rose-600">
                  <td className="py-2">
                    استقطاع أيام تجاوز الرصيد ({settlement.aysed_unpaid_days.toFixed(1)} يوم تُرحل لمسير الرواتب)
                  </td>
